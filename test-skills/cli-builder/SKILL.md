---
name: cli-builder2
description: Guide for building TypeScript CLIs. Use when creating command-line tools, adding subcommands to existing CLIs, or building developer tooling. Covers argument parsing, subcommand patterns, output formatting, and distribution.
---
